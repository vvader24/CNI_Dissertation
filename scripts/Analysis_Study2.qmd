...
### Results section: Overall trends across levels and relationship type
...
#overall_groupwise_table("Individual", "Quadratic")
```

```{r overall-groupwise-effects-table, echo = F, results='asis', eval=FALSE, }
#| cache: true
#| cach-refresh: true
...
scale_color_manual(
   ...
   theme(plot.title.position = "plot", 
      ...
      size = 13),
      plot.caption = element_markdown(hjust =-.38, size = 8.3) )
```
